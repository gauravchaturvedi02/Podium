...
$cat_sql="SELECT article.ar_id,article.au_id,article.tagline,article.flag,article.im_name,article.content,article.title,article.au_name,article.date,article.id,author.description,author.image FROM article JOIN authors ON article.au_id=author.au_id WHERE article.flag='1' AND author.au_id=".$au_id." ORDER BY article.date DESC";
...
<h1 style="padding-top: 80px;font-size: 80px" ><strong><?php echo $cat_r['au_name'];?></strong></h1>
